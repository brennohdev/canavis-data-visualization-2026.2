...
\addlinespace
2 & Como a produtividade da Paraíba evoluiu ao longo das safras? & Rendimento (t/ha) & Evolução & Linha temporal\\
\addlinespace
3 & Como a produtividade da região se compara à média nacional e à de outros estados? & Desvio de produtividade vs.\ referência (\%) & Desvio em relação a referência & Barras divergentes\\
\addlinespace
4 & Quais municípios da Paraíba puxam ou seguram a produtividade estadual? & Rendimento municipal (t/ha); ranking & Ranqueamento & Barras ordenadas\\
\addlinespace
...
\begin{itemize}
  ...
  do Brasil ao município. Coletada via API pública, sem cadastro. Volume: a consulta municipal
  da Paraíba retornou 223 municípios; a consulta nacional cobre as 27 unidades da federação.
...
\begin{enumerate}
  ...
  retornam valor ausente (``-''), o que impede calcular produtividade nesses casos e exige
  tratamento explícito antes de qualquer ranking.
...
fórmula do primeiro foi validada na fase de descoberta: recompor o rendimento a partir de
quantidade e área colhida reproduz exatamente o rendimento publicado pelo IBGE.
...
\begin{enumerate}
  ...
  \\ Referência: média estadual, média nacional e safra anterior.
  ...
  \item \textbf{Desvio de produtividade em relação à referência.}
  \\ Fórmula: (produtividade da unidade $-$ média do grupo) $\div$ média do grupo $\times$ 100.
  \\ Unidade: \%. \quad Sentido: positivo é melhor.
  \\ Referência: média da microrregião, do estado ou do país.
...
% ==================================================================
\section{Esboço de baixa fidelidade}
...
região está''), que é a mais geral, e deixa evolução e ranking como aprofundamento. O esboço
detalhado da tela principal e de ao menos uma tela secundária é entregue à parte, feito no
Figma, sem cores definitivas, sem dados reais e sem logotipos, indicando o que fica acima da
dobra, onde ficam os filtros, onde fica a mensagem principal, o que é clicável e o que é
apenas informativo.

\begin{center}
\fbox{\begin{minipage}{0.92\textwidth}
\centering\vspace{1.2cm}
\textit{[Espaço reservado para os três esboços de baixa fidelidade e o esboço detalhado.
Arquivos entregues em imagem/PDF junto ao pacote da Etapa~1.]}
\vspace{1.2cm}
\end{minipage}}
\end{center}
...
A mudança de rota entre essas telas é o compromisso que será cobrado nas Etapas 2 e 3.
...
\textbf{O que ainda está incerto e será decidido na Etapa 2?} Duas escolhas de fundo. A
primeira é a regra de alinhamento entre ano civil (IBGE) e safra (CONAB), que precisa ser
testada com os dados reais antes de virar medida. A segunda é o nível de granularidade que
sustenta a comparação sem cair na armadilha da supressão municipal: pode ser que a
microrregião seja o recorte mais honesto para rankings, deixando o município para consulta
individual.
