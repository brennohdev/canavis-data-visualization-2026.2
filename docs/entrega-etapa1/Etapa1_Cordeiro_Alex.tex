...
A partir do esboço A escolhido, foi detalhado o fluxo de navegação, feito no Figma,
sem cores definitivas, sem dados reais e sem logotipos. O esboço detalhado está disponível no Figma:
\href{https://www.figma.com/design/Q9GUVPPYaFZRSZYgWkuoGk/CanaVis?node-id=0-1&t=KTiA0CZoBhRHcCL0-1}{figma.com/design/CanaVis}.
As três telas do fluxo são apresentadas a seguir.
